...
```{r}
library(readr)
movies <- read_csv("C:/Users/User/Documents/YorkU/YorkU-ML/recSys-model-netflix/data/movies_metadata.csv")
ratings <- read_csv("C:/Users/User/Documents/YorkU/YorkU-ML/recSys-model-netflix/data/ratings_small.csv")
```
...
recc_predicted$movieId <- as.integer(recc_predicted$movieId)
```
...
```{r}
recc_predicted2$movieId2 <- as.integer(recc_predicted2$movieId2)
```
...
```{r}
recc_predicted3$movieId3 <- as.integer(recc_predicted3$movieId3)
```
